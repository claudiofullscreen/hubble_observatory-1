...
RSpec.describe HubbleObservatory::TalentAccount do
  ...
  describe "create" do
    context "with valid arguments" do
      let(:talent_account_creation) { HubbleObservatory::TalentAccount.create(email: valid_email) }
    ...
    context "with invalid arguments" do
      let(:talent_account_creation) { HubbleObservatory::TalentAccount.create(email: invalid_email) }
  ...
  describe "update" do
    context "with valid arguments" do
      let(:talent_account_update) { HubbleObservatory::TalentAccount.new(id: hubble_uuid).update(email: valid_email) }
      it "should return a TalentAccount hubble id" do
    ...
    context "with invalid arguments" do
      let(:talent_account_update) { HubbleObservatory::TalentAccount.new(id: hubble_uuid).update(email: invalid_email) }
      it "should be nil" do
